...
namespace AIRegister.Migrations
{
    ...
    [Migration("20231115103209_UnambiguousReferance")]
    partial class UnambiguousReferance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLogic.Entities.AuthorisedRepresentativesEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AuthorisedRepresentatives");
                });
            ...
            modelBuilder.Entity("BusinessLogic.Entities.AuthorisedRepresentativesEntity", b =>
                {
                    b.HasOne("BusinessLogic.Entities.ProviderEntity", "Provider")
                        .WithMany("authorisedReperesentitiveEntity")
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessLogic.Entities.ProviderEntity", b =>
                {
                    ...
                    b.Navigation("authorisedReperesentitiveEntity");
                });
